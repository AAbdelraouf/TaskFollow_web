...
const Body = ({ _this }) => {
  return (
    <div className="w-screen flex flex-col sm:flex-row justify-center h-full home_gradient_bg">
      <div className="flex-1 flex basis-1/4 justify-start">
        <div className="flex sm:w-[425px] w-full flex-col bg-background justify-center items-start p-8">
